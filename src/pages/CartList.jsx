    ...
    return (
        <div className='container mx-auto'>
            ...
            <div className='grid grid-cols-3 gap-5'>
                ...
                {/* Summary */}
                <div className='col-span-1 rounded-lg border h-fit w-fit mx-auto border-teal-500 p-5'>
                    <h2 className='text-green-500 text-2xl font-semibold text-center border-b-2 border-green-500 pb-2 mb-5'>Summary</h2>
                    <div>
                        <div className='flex justify-between items-center gap-20 border-b border-dashed mb-3'>
                            <p>Subtotal:</p>
                            <p>{subtotal} Tk</p>
                        </div>
                        <div className='flex justify-between items-center gap-20 border-b border-dashed mb-3'>
                        ...
                        <div className='flex justify-between items-center gap-20 font-semibold text-lg mb-3'>
                            <p>Total:</p>
                            <p>{total} Tk</p>
                        </div>
                    </div>
                    ...
                    <Link to="/checkout" className="bg-white p-2 shadow-top sticky bottom-0">
                        <button className="btn bg-green-500 text-white w-full">
                            Proceed to Checkout <FaArrowRight className='text-xl' />
                        </button>
                    </Link>
                </div>
            </div>
